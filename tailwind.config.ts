  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "glow-pulse": {
          "0%": {
            boxShadow: "0 0 5px hsl(var(--metro-cyan)), 0 0 10px hsl(var(--metro-cyan)), 0 0 15px hsl(var(--metro-cyan))"
          },
          "100%": {
            boxShadow: "0 0 10px hsl(var(--metro-cyan)), 0 0 20px hsl(var(--metro-cyan)), 0 0 30px hsl(var(--metro-cyan))"
          }
        },
      },
      animation: {
