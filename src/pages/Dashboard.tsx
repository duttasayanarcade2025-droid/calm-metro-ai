    ...
    <div className="min-h-screen bg-gradient-to-br from-metro-deep via-background to-metro-surface">
      ...
      <div className="container mx-auto px-6 py-8">
        ...
        >
          <Button 
            size="lg"
            className="bg-gradient-to-r from-metro-cyan to-metro-teal hover:from-metro-cyan/90 hover:to-metro-teal/90 text-white px-8 py-4 text-lg font-semibold shadow-lg hover:shadow-xl transition-all duration-300"
          >
